                ...
                <div class="container pos-vertical-center">
                    <div class="row">
                        <div class="col-md-7 col-lg-5">
            				<h4> Grazie <%=request.getParameter("cognome") %> <%=request.getParameter("nome") %> per esserti registrato.</h4>
            				<h5>Abbiamo inviato una mail di conferma a <%=request.getParameter("email") %>. </h5>
            				<h5>Clicca sul link per confermare il tuo account</h5>    
				</div>
                    </div>
                </div>
            </section>
